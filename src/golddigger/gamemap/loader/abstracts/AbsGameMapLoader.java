...
package golddigger.gamemap.loader.abstracts;

import golddigger.gamemap.interfaces.IntMainMap;
 ...
 * @author alexkurocha
 */
public abstract class AbsGameMapLoader implements IntMainMap, Serializable {
    private int width;
    private int height;
    ...
    public AbsGameMapLoader(GameCollection gameCollection) {
   ...
   public GameCollection getGameCollection() {
        if (gameCollection == null) {
            try {
                ...
                Logger.getLogger(AbsGameMapLoader.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
